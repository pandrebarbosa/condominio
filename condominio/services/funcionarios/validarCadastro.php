...
if( $Pessoa->getNuCpf() == null ){
	$resultado =  array("id" => null, "tipo" => "danger", "msg" => "CPF não preenchido!");
...
if( $Pessoa->getDtNascimento() == null ){
	$resultado =  array("id" => null, "tipo" => "danger", "msg" => "Nascimento não preenchido!");
	echo json_encode($resultado);
	exit;
}
...
if( $Funcionario->getDtEntrada() == null ){
	$resultado =  array("id" => null, "tipo" => "danger", "msg" => "Data de início no condomínio não preenchida!");
	echo json_encode($resultado);
	exit;
}
