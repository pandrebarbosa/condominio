...
class toolBox
{
    ...
    static function retornaData()
    {
        ...
        $msg = "$dia_semana, $dia de $mes de $ano $hora:$minuto:$segundo";
        return $msg;
    }
    ...
    static function retornaNomeSobrenome($nomeCompleto){
    	
    	$nomeEmPartes = explode(" ", $nomeCompleto);
    	$nome = $nomeEmPartes[0];
    	$ultNome = count($nomeEmPartes)-1;
    	$sobrenome = $nomeEmPartes[$ultNome];
