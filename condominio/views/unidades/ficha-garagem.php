...
<div class="panel panel-default">
  <div class="panel-heading">
	<ol class="breadcrumb">
	  ...
	  <li><a href="?ido=<?php echo base64_encode("unidades-listar-por-morador")?>">Unidades</a></li>
  ...
  <div class="panel-body">
    <form role="form" name="frm-moradores" id="frm-moradores">
    	...
    	<div class="panel-footer text-right">
    		...
    		<input type="hidden" id="nu_numero" value="<?php echo isset($_GET['nu_numero']) ? $_GET['nu_numero'] : ''?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
				...
				<input type="hidden" id="co_unidade" value="<?php echo isset($_GET['co_unidade']) ? $_GET['co_unidade'] : ''?>">
				<input type="hidden" id="co_torre" value="<?php echo isset($_GET['co_torre']) ? $_GET['co_torre'] : ''?>">
				<input type="hidden" id="nu_numero" value="<?php echo isset($_GET['nu_numero']) ? $_GET['nu_numero'] : ''?>">  			
            </div>
...
var carregaTipoMorador = function(selecionado) {
	...
	$.ajax({
	  ...
	  url: "services/tipos-de-moradores/listarTipoMorador.php"
		...
		var options;
		var filtro = data.filter(function (value) {
			  return value.co_tipo_morador == 1 || value.co_tipo_morador == 4;
		});	
		$.each(filtro, function (key, val) {
...
var ValidaCampoMorador = function() {
    if ($("#co_unidade").val() == ""){
    	mostrarAlertas("danger","Unidade não identificada!");
        return false;
    }
    if ($("#co_tipo_morador").val() == ""){
    	mostrarAlertas("danger","Tipo de morador não identificado!");
        return false;
    }
    ...
    if ($("#co_tipo_morador").val() == 1 || $("#co_tipo_morador").val() == 4){
        if ($("#nu_cpf").val() == "" ||
            	...
            	mostrarAlertas("danger","CPF do <b>proprietário ou locatário</b> inválido!");
                $("#nu_cpf").focus();
                return false;
            }
    }
    ...
    if ($("#no_pessoa").val() == ""){
    	mostrarAlertas("danger","Nome do morador não preenchido!");
        $("#no_pessoa").focus();
        return false;
    }
    if ($("#dt_inicio").val() == ""){
    	mostrarAlertas("danger","Data de início não preenchido!");
        $("#dt_inicio").focus();
        return false;
    }
...
var ValidaContato = function() {
    ...
    if ($("#ds_contato").val() == ""){
    	mostrarAlertas("danger","Contato do morador não preenchido!");
        $("#ds_contato").focus();
        return false;
    } 
...
var carregaImagem = function(arquivo) {
	var src = '<?php echo $_SESSION['credencial']['ambiente']=="DEV" ? "/condominio" : "" ?>/arquivos/imagens/pessoas/' + arquivo;
	limparImagem();
