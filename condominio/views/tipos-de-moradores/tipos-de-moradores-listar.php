...
var montaResultadoTabela = function(result, header, divResultado, pagina, criterio, maximo) {
	...
	$.each(result, function (key, val) {
		...
		if(i>1){
			...
			tabela += "<td>";
			tabela += "<a class='btn btn-primary btn-sm' title='Detalhar' href='default.php?ido=tipos-de-moradores-manter&co_tipo_morador=" + val.co_tipo_morador+"'><i class='glyphicon glyphicon-pencil'></i></a>";
			tabela += "</td>";
			tabela += "</tr>";
		}else{
			total = val.total;
...
$( "#btn-novo" ).click(function() {
	document.location.href='?ido=tipos-de-moradores-manter';
});	
</script>