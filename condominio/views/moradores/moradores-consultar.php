...
var grid = $("#grid").bootgrid({
    ...
    grid.find(".morador").on("click", function(e) {
    	document.location.href="default.php?ido=<?php echo base64_encode("moradores-visualizar")?>&co_unidade="+$(this).data("row-unidade")+"&nu_numero="+$(this).data("row-numero")+"&no_torre="+$(this).data("row-torre");
    });
});
</script>