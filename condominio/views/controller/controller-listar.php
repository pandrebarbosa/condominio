...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		<div class="row">
		  <div class="col-md-5">
		  	<input type="text" class="form-control" id="criterio" placeholder="Busca de controller">
		  </div>
		  <div class="col-md-5">
				<button class="btn btn-info" id="btn-buscar">Buscar</button>
				<button class="btn btn-warning" id="btn-reset">Limpar</button>
				<button class="btn btn-primary" id="btn-novo">Novo item de controller</button>		  
		  </div>
...
var grid = function(maximo, pagina, criterio) {		
	$.ajax({
	  ...
	  dataType: "json",
	  loading: true,
	  url: "services/controller/listar.php",
	  data: { maximo: maximo, pagina: pagina, criterio: criterio }
	}).done(function( data ) {		
		var header = ["no_controller", "ds_controller", "ds_caminho"];
