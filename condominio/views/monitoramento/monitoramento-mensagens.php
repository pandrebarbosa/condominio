...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="row">
		  ...
		  <div class="col-md-5">
		  	<input type="text" class="form-control" id="criterio" placeholder="Digite...">
		  </div>
		  <div class="col-md-5">
...
var grid = function(maximo, pagina ,criterio) {	
	$.ajax({
	  ...
	  dataType: "json",
	  loading: true,	  
	  url: "services/mensagens/listarUsuariosQueLeramMensagens.php",
	  data: { pagina: pagina, criterio: criterio, maximo: maximo }
	}).done(function( data ) {
		var header = ["Código", "Mensagem", "Usuário", "Leitura"];
