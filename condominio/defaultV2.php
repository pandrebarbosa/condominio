...
<html lang="pt-br">
  ...
  <body>
    ...
    <p></p>
      ...
      <div class="masthead">    
			<?php include("menu/menu-superior.php") ?>
      </div>
      ...
      <div class="footer">
        <hr />
        <p>&copy; Condomínio San Raphael <small style="color:#fff">Ambiente: <?php echo $_SESSION['credencial']['ambiente']?></small></p>
      <div style="font-size: 10px;">Icons made by
