...
(function (factory) {
    ...
    return moment.defineLocale('pt-br', {
        ...
        longDateFormat : {
            ...
            L : 'DD/MM/YYYY',
            LL : 'D [de] MMMM [de] YYYY',
            LLL : 'D [de] MMMM [de] YYYY [á s] LT',
            LLLL : 'dddd, D [de] MMMM [de] YYYY [á s] LT'
        },
        calendar : {
            sameDay: '[Hoje á s] LT',
            nextDay: '[Amanhã á s] LT',
            nextWeek: 'dddd [á s] LT',
            lastDay: '[Ontem á s] LT',
            lastWeek: function () {
                return (this.day() === 0 || this.day() === 6) ?
                    '[Último] dddd [á s] LT' : // Saturday + Sunday
                    '[Última] dddd [á s] LT'; // Monday - Friday
            },
            sameElse: 'L'
        },
        relativeTime : {
