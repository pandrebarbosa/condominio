...
$(function() {
    ...
    PcLoading = {
        show: function(c, a) {
            ...
            c = "undefined" == typeof c ? "Aguarde..." : c;
            a = "undefined" == typeof a ? "Aguarde!" : a;
    ...
    a.fn.uploadAjax = function(g) {
        ...
        return this.each(function() {
            ...
            h.css({
                ...
                "z-index": 10,
                overflow: "hidden"
            }).attr("title", "Clique para mudar a foto.");
    ...
    var methods = {
        ...
        init: function(Options) {
            ...
            return this.each(function() {
                ...
                var TuyoshiCrop = function(element, response) {
                    ...
                    var MontarSelecaoRecorte = function(SelecaoRecorte, state) {
                        ...
                        if (state == "create") {                            
                            ...
                            if (ElemSelectProporcao.find("option").length > 0) {
                    ...
                    if (Options.CropWindowStyle == "jqueryui") PcDialog(Options.PluginFolderOnServer + CropWindowStyle[Options.CropWindowStyle], "JtuyoshiCrop", "Cortar Imagem", 900, 555, true, true, false, null, JpaneDialogCallBack);
                    else if (Options.CropWindowStyle == "popstyle") JpaneDialogCrop(Options.PluginFolderOnServer + CropWindowStyle[Options.CropWindowStyle], "Cortar Imagem", 980, 555, true, false, false, null, JpaneDialogCallBack);
                    else if (Options.CropWindowStyle == "bootstrap") PcDialog(Options.PluginFolderOnServer + CropWindowStyle[Options.CropWindowStyle], "JtuyoshiCrop", "Cortar Imagem", 900, 555, true, true, false, null, JpaneDialogCallBack)
                };
                ...
                if (Options.EnableButton) {
                    $EnableButton = $("<input type='button' id='btn-selec-foto' value='Selecionar foto' />").button().css({
                        "font-size": "12px",
                        "margin-top": "-31px",
                        "margin-left": "65px"
                    });
